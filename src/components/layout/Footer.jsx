...
const Footer = () => {
    return (
        <footer id="footer" className="bg-bg-dark border-t border-white/10 pt-16 pb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm text-gray-400">
                            ...
                            <li className="flex items-start gap-2">
                                ...
                                <span>Surat / Jamnagar,<br />Gujarat, India</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.linkedin.com/company/coreaix-labs-llp/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/5 rounded-full hover:bg-primary/20 hover:text-primary transition-colors text-gray-400">
                                <Linkedin size={20} />
                            </a>

                        </div>
                        <div className="mt-6">
                            <div className="text-xs text-gray-500 border border-white/10 rounded px-3 py-2 inline-block">
                                DPIIT Recognized Startup<br />
                                <span className="text-primary">DIPP243118</span>
                            </div>
                        </div>
                    </div>
                </div>
